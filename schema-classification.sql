...
create table entity_qualifier_value (
  ...
  qualifier_value_score int(11) NOT NULL,  
  PRIMARY KEY (id),
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 1, 3, 85);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 1, 11, 75);

insert into posts (title, body, date_created) values
('Recycling of plastics', 
'Have you considered the amount of plastic used within a household, particularly in toys?  Why not re-use old toys?', 
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 2, 3, 25);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 2, 12, 50);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 2, 16, 75);
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 3, 4, 80);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 3, 10, 20);
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 4, 3, 100);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 4, 16, 65);
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 5, 1, 45);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 5, 4, 45);
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 6, 4, 75);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 6, 14, 75);
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 7, 4, 100);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 7, 10, 45);
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 8, 1, 25);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 8, 16, 45);

insert into posts (title, body, date_created) values
('Telsa model S enters production', 
'The Model S sedan is now avialable in limited production.', 
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 9, 4, 50);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 9, 10, 75);
...
now());
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 10, 1, 75);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 10, 3, 55);
insert into entity_qualifier_value (entity_type, entity_id, qualifier_value_id, qualifier_value_score) values ('POST', 10, 14, 45);
